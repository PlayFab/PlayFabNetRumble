...
void Leaderboard::ShowLeaderboard(SteamLeaderboard_t hLeaderboard, ELeaderboardDataRequest eLeaderboardData, int offset)
{
	if (hLeaderboard)
	{
...
void Leaderboard::GetLeaderboards(LeaderboardsTypes typeOfLeaderboard)
{
...
void Leaderboard::FindLeaderboards()
{
...
void Leaderboard::UpdateLeaderboards(LeaderboardsTypes typeOfLeaderboard)
{
...
void Leaderboard::OnUploadScore(LeaderboardScoreUploaded_t* pFindLearderboardResult, bool bIOFailure)
{
...
void Leaderboard::SetFindLeaderboardCallback(FindLeaderboardCallback completionCallback)
{
	m_FindLeaderboardCallback = completionCallback;
}

void Leaderboard::OnFindLeaderboard(LeaderboardFindResult_t* pFindLearderboardResult, bool bIOFailure)
{
