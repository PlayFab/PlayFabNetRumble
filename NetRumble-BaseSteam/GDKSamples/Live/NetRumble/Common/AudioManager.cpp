...
void AudioManager::Tick()
{
	...
	{
		OnlineVoiceChat::GetInstance().GetVoiceChat()->Tick();
	}
...
bool AudioManager::StartVoiceChat()
{
	return OnlineVoiceChat::GetInstance().StartVoiceChat();
}

bool AudioManager::StopVoiceChat()
{
	return OnlineVoiceChat::GetInstance().StopVoiceChat();
}
